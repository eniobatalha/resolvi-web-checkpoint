            ...
            <section className="flex">
                <div className="w-[32%] py-10 flex flex-col items-center">
                    <div className="flex flex-col w-full items-center">
                        <img className="rounded-full w-[120px] h-[120px] object-cover" src="https://foxproject.org.uk/cdn/shop/files/bobby_fox_small_2821c266-337d-4fac-be0a-a0784f71d194.jpg?v=1706250016" alt="Professional image"/>
